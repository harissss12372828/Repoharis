...
require('../nodeJS/lynzz')(lynzz, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
...
lynzz.ev.on('group-participants.update', async (update) =>{
groupResponse_Demote(lynzz, update)
groupResponse_Promote(lynzz, update)
groupResponse_Welcome(lynzz, update)
groupResponse_Remove(lynzz, update)
console.log(update)
})
